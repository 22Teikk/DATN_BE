...
class StoreSchema(Schema):
    ...
    open_time = fields.Str(required=True, metadata={"description": "Opening time of the store"})
    close_time = fields.Str(required=True, metadata={"description": "Closing time of the store"})
